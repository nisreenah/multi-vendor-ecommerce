                    ...
                    <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="border p-4 rounded">
                            ...
                            <div class="card-title d-flex align-items-center">
                                <h5 class="mb-0 text-info"><i class='bx bx-cookie'></i> Update Brand</h5>
                            </div>
                            <hr/>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" value="{{ old('name', $brand->name) }}" type="text"
                                           class="form-control" id="name" placeholder="Brand Name">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="slug" value="{{ old('slug', $brand->slug) }}" type="text"
                                           class="form-control" id="slug" placeholder="slug-name">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="image" class="col-sm-3 col-form-label">Upload A Brand Image</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <img class="" border="2" width="250px"
                                         src="{{ asset('upload/brands/'. $brand->image ) }}">
                                </div>
                            </div>
